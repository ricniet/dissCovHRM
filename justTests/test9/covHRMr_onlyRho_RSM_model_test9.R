...
write.csv(covHRM_results, file='./justTests/test8/covHRMr_RHOonly_test9_N500R50J8K5_3ch.csv')
save(covHRM_jags, file='./justTests/test8/covHRMr_RHOonly_test9_N500R50J8K5_3ch.Rdat')

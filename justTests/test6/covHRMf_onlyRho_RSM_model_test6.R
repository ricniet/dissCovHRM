...
write.csv(covHRM_results, file='./justTests/test6/covHRMf_RHOonly_test6_N500R50J8K5_3ch30000i15000b30t.csv')
save(covHRM_jags, file='./justTests/test6/covHRMf_RHOonly_test6_N500R50J8K5_3ch30000i15000b30t.Rdat')

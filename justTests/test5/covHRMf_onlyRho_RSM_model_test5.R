...
write.csv(covHRM_results, file='./justTests/test5/covHRMf_RHOonly_test5_N500R50J8K5_3ch20000i10000b20t.csv')
save(covHRM_jags, file='./justTests/test5/covHRMf_RHOonly_test5_N500R50J8K5_3ch20000i10000b20t.Rdat')

source('./justTests/assessTests.R')

assess(jagsObj = covHRM_jags, 
       R = R,
       filePath = './justTests/test5/',
       eval = c(1:47,49),
       random = F)

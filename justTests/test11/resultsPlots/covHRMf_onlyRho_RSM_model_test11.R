...
write.csv(covHRM_results, file='./justTests/test11/covHRMf_RHOonly_test5_N500R50J8K5_3ch16000i8000b16t.csv')
save(covHRM_jags, file='./justTests/test11/covHRMf_RHOonly_test5_N500R50J8K5_3ch16000i8000b16t.Rdat')

source('./justTests/assessTests.R')

assess(jagsObj = covHRM_jags, 
       R = R,
       filePath = './justTests/test11/',
       eval = c(1:47,49),
       random = F)
